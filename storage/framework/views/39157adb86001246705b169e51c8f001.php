    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('post.update', $post)); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="post_type_id" id="post_type_id">
                            ...
                            <?php $__currentLoopData = $post_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e($post->post_type_id === $post_type->id ? 'selected' : ''); ?> value="<?php echo e($post_type->id); ?>"><?php echo e($post_type->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <img id="imagePreview" class="m-3 rounded-1" src="<?php echo e($post->thumbnail); ?>" width="250">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DoAn\resources\views/admin/post/edit.blade.php ENDPATH**/ ?>