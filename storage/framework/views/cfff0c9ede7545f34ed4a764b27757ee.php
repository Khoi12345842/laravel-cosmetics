                                ...
                                <tr>
                                  <th class="column_logo"
                                    ...
                                    <a href="<?php echo e(route('home')); ?>"
                                      ...
                                      <img
                                        src="<?php echo e(asset('assets/frontend/img/home/logo-black.png')); ?>"
                                ...
                                <tr id="section-1468267" class="section introduction">
                                  <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff">
                                    ...
                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;"
                                      align="center">Chúng tôi đã nhận được đơn đặt hàng của bạn. Cảm ơn vì đã tin tưởng và ủng hộ <?php echo e(config('app.name')); ?>.</p>
                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;"
                                ...
                                <tr id="section-1468270" class="section order_number_and_date">
                                  <th style="mso-line-height-rule: exactly; padding: 13px 52px;" bgcolor="#ffffff">
                                    <h2
                                      ...
                                      align="center">
                                      <span data-key="1468270_order_number">Đơn hàng </span>Ngày đặt hàng #<?php echo e($order->id); ?>
                                    ...
                                    <p class="muted"
                                      ...
                                      align="center"><?php echo e(date_format($order->created_at, 'd/m/Y')); ?></p>
                                  </th>
                                </tr>
                                                      ...
                                                      <tbody>
                                                        <tr>
                                                          ...
                                                          <th class="right line-item-line-price" width="1"
                                                            ...
                                                            <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                              align="right">
                                                              <?php echo e(convertPrice($product->pivot->price, ' VNĐ')); ?>
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  ...
                                                  <th class="table-text"
                                                    ...
                                                    <?php echo e(convertPrice($order->total_price, ' VNĐ')); ?></th>
                                                </tr>
                                                <tr>
                                                  <!-- Discount -->
                                                ...
                                                <tr class="pricing-table-total-row">
                                                  ...
                                                  <th class="table-text"
                                                    style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; width: 35%; padding: 6px 0;"
                                                    align="right" bgcolor="#ffffff" valign="middle">
                                                    <?php echo e(convertPrice($order->total_price*(1-0/100), ' VNĐ')); ?></th>
                                                </tr>
                                                <!-- End Total Price -->
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  <th class="billing_address "
                                                    ...
                                                    align="left" bgcolor="#ffffff" valign="top">
                                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                      align="left">Họ tên : <?php echo e($order->name); ?><br>
                                                       Số điện thoại: <?php echo e($order->phone); ?><br>
                                                      Địa chỉ: <?php echo e($order->address); ?><br>
                                                      Note:  <?php echo e($order->note); ?><br>
                                                    </p>
                                                  </th>
                                                </tr>
                                              </tbody>
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  <th class="shipping_address "
                                                    ...
                                                    align="right" bgcolor="#ffffff" valign="top">
                                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                      align="right"><?php echo e($order->payment == 'cod' ? 'Thanh toán khi nhận hàng' : 'Ví ' . strtoupper($order->payment)); ?>
                                ...
                                <tr id="section-1468276" class="section closing_text">
                                  <th data-key="1468276_closing_text" class="text"
                                    ...
                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                      ...
                                      email: <?php echo e(config('mail.from.address')); ?></p>
                                  </th>
                                </tr>
                                              ...
                                              <tbody>
                                                <tr style="" align="center">
                                                  <th class="column_shop_block2 " data-key="section_shop_block2"
                                                    ...
                                                    align="center" bgcolor="#ffffff" valign="top">
                                                    <?php echo e(config('app.name')); ?><br style="text-align: center;">
                                        ...
                                        <tr>
                                          <th class="column_shop_block1 " width="100%"
                                            ...
                                            <a href="#" target="_blank" data-key="section_shop_block1"
                                              style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; font-weight: 400; text-transform: none;"><?php echo e(config('app.url')); ?></a>
                                          </th>
                                        </tr>
                                        <!-- Store Website : END -->
                                      </tbody>
...
<?php /**PATH D:\laravel-ecommerce\DoAn\resources\views/frontend/mails/order_confirmation.blade.php ENDPATH**/ ?>