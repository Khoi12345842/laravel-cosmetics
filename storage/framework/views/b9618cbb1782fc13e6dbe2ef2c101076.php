...
<?php $__env->startSection('page-class', 'user-wishlist blog'); ?>
                                ...
                                <div id="mywishlist">
                                    ...
                                    <div id="block-history" class="block-center">
                                        <table class="std table">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $favoriteProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr id="wishlist_1">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo e(route('product', $product)); ?>">Chi tiết</a>
                                                    </td>
                                                    <td class="wishlist_delete">
                                                        <span onclick="confirmDelete(<?php echo e($product->id); ?>)">Xóa</span>
                                                    </td>
                                                </tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\cosmetics\resources\views/frontend/favorite.blade.php ENDPATH**/ ?>