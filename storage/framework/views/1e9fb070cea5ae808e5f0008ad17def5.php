            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="<?php echo e(route("admin.dashboard")); ?>" class="text-nowrap logo-img">
                        <img src="<?php echo e(asset('assets/frontend/img/home/logo-black.png')); ?>" width="180" alt="" />
                    </a>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('origin.index')); ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('order.index')); ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('post_type.index')); ?>" aria-expanded="false">
                                <span>
                                    <i class="ti ti-category"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('post.index')); ?>" aria-expanded="false">
                                <span>
                                    <i class="ti ti-ballpen"></i>
                                </span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.password')); ?>" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?php echo e(route('admin.logout')); ?>" aria-expanded="false">
                                <span>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="bellIcon">
                        ...
                        <?php if($pendingOrders->count() > 0): ?>
                            <span class="badge bg-primary rounded-circle"><?php echo e($pendingOrders->count()); ?></span>
                        <?php endif; ?>
                    </a>
                </li>
                                    ...
                                    <ul class="list-group">
                                        <?php $__currentLoopData = $pendingOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="list-group-item">
                                                ...
                                                <strong>Mã đơn hàng: #<?php echo e($order->id); ?></strong> || Ngày đặt hàng: <?php echo e($order->created_at->format('d/m/Y H:i')); ?>

                                                || Tên khách hàng: <?php echo e($order->name); ?>
...
<?php /**PATH D:\laravel-ecommerce\DoAn\resources\views/admin/layout/master.blade.php ENDPATH**/ ?>