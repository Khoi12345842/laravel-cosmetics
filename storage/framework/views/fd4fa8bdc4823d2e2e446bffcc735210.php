                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="post_type_id" id="post_type_id">
                            ...
                            <?php $__currentLoopData = $post_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($post_type->id); ?>"><?php echo e($post_type->name); ?></option>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DoAn\resources\views/admin/post/create.blade.php ENDPATH**/ ?>