                ...
                <div class="card-body display_data">
                    ...
                    <div class="position-relative row form-group align-items-center">
                        ...
                        <div class="position-relative row form-group align-items-center">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <span><?php echo e($order->created_at ? \Carbon\Carbon::parse($order->created_at)->format('d/m/Y') : ''); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group align-items-center">
                            ...
                            <div class="col-md-9 col-xl-8">
                                ...
                                <?php elseif($order->status === 2): ?>
                                    ...
                                    <a href="<?php echo e(route('order.confirm', $order)); ?>" class="btn btn-outline-success m-1" style="margin-left: 10px">Xác nhận</a>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DoAn\resources\views/admin/order/show.blade.php ENDPATH**/ ?>